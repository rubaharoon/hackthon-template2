    ...
    <div>
      ...
      <div className="w-full h-auto flex flex-col md:flex-row justify-between items-center px-4 md:px-16 py-8">
        ...
        <div className="mt-6 md:mt-0">
          <Link href="/productlisting">
            <button className="bg-gray-200 h-12 w-40 rounded-sm text-[#2A254B] hover:bg-[#2A254B] hover:text-white transition-colors duration-300">
              View our products
            </button>
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 items-center h-auto md:h-[478px] mx-4 mb-4">
        ...
        <div className="bg-[#2A254B] h-[400px] text-white flex flex-col justify-center p-6 md:pl-10 mt-[-80px]">
          ...
          <Link
            href="/productlisting"
            className="bg-[#F9F9F926] text-white text-center font-medium text-sm md:text-base hover:bg-slate-400 hover:text-black max-w-max py-3 px-6 rounded-lg transition-all duration-300"
          >
            View Collection
          </Link>
        </div>
      ...
      <div className="flex flex-col md:flex-row w-full h-auto items-center px-4 py-16 space-y-8 md:space-y-0">
        ...
        <div className="border-2 bg-slate-200 w-full md:w-3/5 p-8 md:p-20">
          ...
          <button className="bg-white h-12 w-40 rounded-sm mt-10 text-[#2A254B] hover:bg-[#2A254B] hover:text-white transition-colors duration-300">
            Get in Touch
          </button>
        </div>
      </div>
