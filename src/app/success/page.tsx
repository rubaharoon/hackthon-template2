...
const SuccessIcon = () => (
  <div className="flex justify-center mb-8">
    <CheckCircle className="w-24 h-24 text-green-500 animate-bounce" aria-hidden="true" />
  </div>
);
...
export default function PaymentSuccessPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 to-indigo-400 wrapper">
      <div className="bg-white rounded-xl shadow-2xl p-10 max-w-md w-full transform transition-all duration-300 hover:scale-105">
        ...
        <div className="text-center">
          <Link
            ...
            aria-label="Generate Tracking Number"
          >
